...
let directory = URL(fileURLWithPath: FileManager.default.currentDirectoryPath).appendingPathComponent("design/voice-input-20260915")
guard let svg = NSImage(contentsOf: directory.appendingPathComponent("blueprint.svg")) else {
    fatalError("NSImage SVG support unavailable")
}
let width = 3000, height = 2340
